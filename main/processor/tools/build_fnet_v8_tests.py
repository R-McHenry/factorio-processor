...
Unlike the archived pre-fnet build_v8_tests.py (master entity numbers, signal_space letters), all
...
literals, valid under any exclusion set (plan/NETLIST_PLAN.md "regenerate everything
together").
...
from processor.isa import (IR8, JUMP_REL_RESUME, config_from_signals_map,  # noqa: E402
...
def fib_cmp(cfg, rows):
    """The v8 fib_cmp program (processor.isa self-test) scheduled against the
    ...
    return prog, timeline, ("processor.isa-scheduled fib_cmp against the fnet "
