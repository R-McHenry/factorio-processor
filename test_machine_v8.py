#!/usr/bin/env python3
"""Self-tests for machine_v8.py (plain asserts, run with the venv python).

The live gate is proc_v8_fib_cmp_v8 / proc_v8_spin_counter in run_all.py;
these tests pin the scheduler's structural guarantees.
"""
import sys
...
from machine_v8 import (ACCUMULATE_CELLS, CELL_TO_USE, IR8, JUMP_REL_RESUME,
                        JUMP_REL_SHADOW, MMAP_B, MachineConfig, VEC_BUS,
                        WRITE_TO_CELL,
                        PARK_A_TO_USE, ScheduleError, schedule8)
from build_v8_tests import fib_cmp_v8  # noqa: F401  (import proves it builds)
...
if __name__ == "__main__":
    ...
    print(f"\n{len(tests)} machine_v8 tests passed")
