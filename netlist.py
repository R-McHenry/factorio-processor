...
See NETLIST_PLAN.md for the language and the resolved design decisions.
...
from factorio_blueprint_codec import encode_blueprint_string
...
# populate-at-paste marker (factorio_memory_tb.write_signal_table). Its
...
class Design:
    ...
    def _resolve_accumulates(self) -> list[dict]:
        ...
        machine_v8 reads back through the signals map."""
        out: list[dict] = []
