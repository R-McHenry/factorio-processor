...
from factorio_blueprint_codec import encode_blueprint_string  # noqa: E402
...
def main() -> None:
    import tools.build_v10_tests as mb
...
def build_combined(args, space, lamps, lamp_wires, at, rows):
    ...
    from tools.export_bp import inline_signal_tables, merge_fixture
    import tools.build_v10_tests as v10
...
def check_geometry(entities, wires):
    ...
    later."""
    import math
    from netlist import ENTITY_INFO
